...
export default function InsurancePremiumCalculator() {
  ...
  const insuranceSuggestions = [
    {
      name: "Standard Plan",
      details: "Basic coverage with minimal premium",
      threshold: 20000,
    },
    {
      name: "Premium Plan",
      details: "Comprehensive coverage with added benefits",
      threshold: 50000,
    },
    {
      name: "Elite Plan",
      details: "High coverage for long-term security",
      threshold: 100000,
    },
  ];

  const suggestedPlan =
    insuranceSuggestions.find((plan) => premium && premium <= plan.threshold) ||
    insuranceSuggestions[insuranceSuggestions.length - 1];
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#073243] via-[#0a4c59] to-[#0d6270] py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-10xl mx-auto space-y-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-cyan-100">
                Calculate your premium based on personalized risk factors
              </p>
            </div>
          ...
          <Card className="shadow-xl bg-white/95 backdrop-blur">
            <h2 className="text-xl font-semibold text-gray-700 px-4 pt-4">
              Suggested Plans
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
              <div className="p-4 bg-indigo-100 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Get up to ₹2 Cr coverage at just ₹599/month. Ideal for young
                  professionals!
                </p>
                <Button
                  type="primary"
              ...
              <div className="p-4 bg-blue-100 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Comprehensive coverage with added benefits for pre-existing
                  conditions.
                </p>
                <Button
                  type="primary"
              ...
              <div className="p-4 bg-green-100 rounded-lg shadow-md md:col-span-2">
                <h3 className="font-bold text-lg text-green-700">
                  Retirement Secure Plan
                </h3>
                <p className="text-gray-600">
                  Enjoy your golden years with guaranteed returns and health
                  benefits.
                </p>
                <Button
                  type="primary"
