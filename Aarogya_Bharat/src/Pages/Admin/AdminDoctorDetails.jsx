...
export default function AdminDoctorDetails() {
    ...
    const fetchDoctor = async () => {
      try {
        const response = await fetch(
          `${import.meta.env.VITE_BACKEND}/api/doctors/${id}`
        );
  ...
  const handleVerify = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND}/api/doctors/verify/${id}`,
        {
          method: "PATCH",
          headers: {
      ...
      if (response.ok) {
        ...
        console.error("Failed to verify doctor");
      }
    } catch (error) {
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="container mx-auto px-4 py-8">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <div className="md:flex">
              ...
              <div className="p-8">
                ...
                {doctor.verified && (
                  <span className="mt-4 text-green-500 font-bold">
                    Doctor Verified
                  </span>
                )}
              </div>
          ...
          <h3 className="text-lg leading-6 font-medium text-gray-900">Documents</h3>
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 flex items-center">
                  <User className="mr-2 h-5 w-5" /> Government ID
                </dt>
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <a
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 flex items-center">
                  <Award className="mr-2 h-5 w-5" /> License
                </dt>
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <a
                    href={doctor.profilePicture}
              ...
              <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500 flex items-center">
                  <Briefcase className="mr-2 h-5 w-5" /> Registration
                  Certificate
                </dt>
                <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                  <a
